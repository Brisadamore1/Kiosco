    ...
    public partial class inicio : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, false, new DateTime(2021, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 21, 1, 1000 },
                    { 2, false, new DateTime(2021, 5, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 10, 2, 2000 },
                    { 3, false, new DateTime(2021, 5, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 5, 3, 3000 },
                    { 4, false, new DateTime(2021, 5, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 0, 4, 4000 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, false, new DateTime(2024, 10, 8, 16, 22, 36, 189, DateTimeKind.Local).AddTicks(5641), 1, 21m, 3000m },
                    { 2, 2, false, new DateTime(2024, 10, 8, 16, 22, 36, 189, DateTimeKind.Local).AddTicks(5665), 2, 10m, 5000m },
                    { 3, 1, false, new DateTime(2024, 10, 8, 16, 22, 36, 189, DateTimeKind.Local).AddTicks(5668), 3, 21m, 8000m }
                });
