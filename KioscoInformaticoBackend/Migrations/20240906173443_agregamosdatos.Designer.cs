...
namespace KioscoInformaticoBackend.Migrations
{
    ...
    [Migration("20240906173443_agregamosdatos")]
    partial class agregamosdatos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KioscoInformaticoBackend.Models.Venta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClienteId = 1,
                            Fecha = new DateTime(2024, 9, 6, 14, 34, 42, 558, DateTimeKind.Local).AddTicks(970),
                            FormaPago = 1,
                            Iva = 21m,
                            Total = 3000m
                        },
                        new
                        {
                            Id = 2,
                            ClienteId = 2,
                            Fecha = new DateTime(2024, 9, 6, 14, 34, 42, 558, DateTimeKind.Local).AddTicks(993),
                            FormaPago = 2,
                            Iva = 10m,
                            Total = 5000m
                        },
                        new
                        {
                            Id = 3,
                            ClienteId = 1,
                            Fecha = new DateTime(2024, 9, 6, 14, 34, 42, 558, DateTimeKind.Local).AddTicks(996),
                            FormaPago = 3,
                            Iva = 21m,
                            Total = 8000m
                        });
